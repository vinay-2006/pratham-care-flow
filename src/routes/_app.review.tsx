...
export const Route = createFileRoute("/_app/review")({
  head: () => ({
    meta: [
      { title: "Doctor Review — PRATHAM" },
      { name: "description", content: "Consolidated workstation for on-arrival review." },
    ],
  }),
...
function ReviewPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-5 py-8 md:px-8">
      <SectionHeader
        eyebrow="Stage 4 · Review"
        title="Doctor Review Dashboard"
        description="Decision support workstation. Raw evidence on the left; AI summary on the right."
          ...
          <CardContent>
            <Tabs defaultValue="vitals">
              ...
              <TabsContent value="labs" className="mt-4">
                {patientCase.recommendedInvestigations.filter((i) => /trop|cbc|lab/i.test(i.name)).length ? (
